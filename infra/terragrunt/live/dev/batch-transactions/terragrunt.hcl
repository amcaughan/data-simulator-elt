...
dependency "core" {
  ...
  mock_outputs = {
    ...
    scheduled_ingest_ecr_repository_url = "111111111111.dkr.ecr.us-east-2.amazonaws.com/data-simulator-elt-dev-scheduled-ingest"
    dbt_ecr_repository_url              = "111111111111.dkr.ecr.us-east-2.amazonaws.com/data-simulator-elt-dev-dbt"
  }
...
inputs = {
  ...
  workflow_name                    = "batch-transactions"
  ...
  ingest_schedule_expression     = "cron(0 */6 * * ? *)"
  dbt_schedule_expression        = "cron(20 */6 * * ? *)"
